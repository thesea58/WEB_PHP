...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 19, 2026 lúc 04:24 PM
...
(30, 'Trà sen Đồng Tháp', 150000.00, 'Trà sen thơm dịu, thanh mát.', 3, 27, 45, '2026-03-18 19:38:44', 'img/Anh/Nam/trasen_dongthap.jpg');
...
--
ALTER TABLE `sanpham`
  MODIFY `ma_sp` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
