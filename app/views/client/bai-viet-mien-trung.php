        ...
        <div class="row justify-content-center">
            <div class="col-md-10 fs-5" style="line-height: 1.8; text-align: justify;">
                ...
                <div class="my-4 text-center">
                    <img src="app/views/client/img/Anh/Trung/cong.jpg" alt="Xóm Tân Long Bình Định" class="img-fluid rounded shadow-sm" style="max-height: 400px; background-color: #f0f0f0;">
